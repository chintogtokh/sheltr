...
def row_to_obj(data):
    ...
    with open('./data/geojson/' + data[0] + "_xaaaa.geojson", 'r') as json_file:
        ...
        return {
            ...
            "university-campus-long.x": {
                "number":float(data[170]),
                "year": "2016",

            },

            "whitehouse-institute-of-design--australia-rank": {
                "number":float(data[629]),
                "year": "2016",

            },

            "william-angliss-institute-rank": {
                "number":float(data[630]),
                "year": "2016",

            },

            "yorke-institute-rank": {
            ...
            "african-languages--nec-population": {
                "number":float(data[689]),
                "year": "2016",

            },

            "african-languages--nfd-population": {
            ...
            "assyrian-neo-aramaic-population": {
            ...
            "burmese-and-related-languages--nec-population": {
                "number":float(data[703]),
                "year": "2016",

            },

            "burmese-and-related-languages--nfd-population": {
            ...
            "chaldean-neo-aramaic-population": {
                "number":float(data[709]),
                "year": "2016",

            },

            "chin-haka-population": {
                "number":float(data[710]),
                "year": "2016",

            },

            "chinese--nfd-population": {
                "number":float(data[711]),
                "year": "2016",

            },

            "creole--nfd-population": {
            ...
            "ilonggo--hiligaynon--population": {
                "number":float(data[740]),
                "year": "2016",

            },

            "inadequately-described-population": {
            ...
            "kinyarwanda--rwanda--population": {
                "number":float(data[749]),
                "year": "2016",

            },

            "kirundi--rundi--population": {
            ...
            "maori--cook-island--population": {
                "number":float(data[763]),
                "year": "2016",

            },

            "maori--new-zealand--population": {
            ...
            "other-southern-asian-languages-population": {
            ...
            "persian--excluding-dari--population": {
                "number":float(data[778]),
                "year": "2016",

            },

            "pidgin--nfd-population": {
            ...
            "southern-asian-languages--nfd-population": {
            ...
            "tok-pisin--neomelanesian--population": {
            ...
            "suburb-speaks-aboriginal-english": {
                "number":float(data[817]),
                "year": "2016",

            },

            "suburb-speaks-acholi": {
                "number":float(data[818]),
                "year": "2016",

            },

            "suburb-speaks-african-languages": {
                "number":float(data[819]),
                "year": "2016",

            },

            "suburb-speaks-afrikaans": {
            ...
            "suburb-speaks-albanian": {
                "number":float(data[822]),
                "year": "2016",

            },

            "suburb-speaks-american-languages": {
                "number":float(data[823]),
                "year": "2016",

            },

            "suburb-speaks-amharic": {
            ...
            "suburb-speaks-arabic": {
                "number":float(data[826]),
                "year": "2016",

            },

            "suburb-speaks-armenian": {
                "number":float(data[827]),
                "year": "2016",

            },

            "suburb-speaks-aromunian-(macedo-romanian)": {
                "number":float(data[828]),
                "year": "2016",

            },

            "suburb-speaks-assamese": {
                "number":float(data[829]),
                "year": "2016",

            },

            "suburb-speaks-assyrian-neo-aramaic": {
                "number":float(data[830]),
                "year": "2016",

            },

            "suburb-speaks-auslan": {
                "number":float(data[831]),
                "year": "2016",

            },

            "suburb-speaks-australian-indigenous-languages": {
            ...
            "suburb-speaks-balinese": {
                "number":float(data[834]),
                "year": "2016",

            },

            "suburb-speaks-balochi": {
            ...
            "suburb-speaks-bengali": {
                "number":float(data[841]),
                "year": "2016",

            },

            "suburb-speaks-bidjara": {
            ...
            "suburb-speaks-bisaya": {
                "number":float(data[844]),
                "year": "2016",

            },

            "suburb-speaks-bislama": {
                "number":float(data[845]),
                "year": "2016",

            },

            "suburb-speaks-bosnian": {
                "number":float(data[846]),
                "year": "2016",

            },

            "suburb-speaks-bulgarian": {
                "number":float(data[847]),
                "year": "2016",

            },

            "suburb-speaks-burmese": {
                "number":float(data[848]),
                "year": "2016",

            },

            "suburb-speaks-burmese-and-related-languages": {
                "number":float(data[849]),
                "year": "2016",

            },

            "suburb-speaks-cantonese": {
                "number":float(data[850]),
                "year": "2016",

            },

            "suburb-speaks-catalan": {
                "number":float(data[851]),
                "year": "2016",

            },

            "suburb-speaks-cebuano": {
                "number":float(data[852]),
                "year": "2016",

            },

            "suburb-speaks-celtic": {
                "number":float(data[853]),
                "year": "2016",

            },

            "suburb-speaks-chaldean-neo-aramaic": {
                "number":float(data[854]),
                "year": "2016",

            },

            "suburb-speaks-chin-haka": {
                "number":float(data[855]),
                "year": "2016",

            },

            "suburb-speaks-chinese": {
                "number":float(data[856]),
                "year": "2016",

            },

            "suburb-speaks-creole": {
                "number":float(data[857]),
                "year": "2016",

            },

            "suburb-speaks-croatian": {
                "number":float(data[858]),
                "year": "2016",

            },

            "suburb-speaks-cypriot": {
            ...
            "suburb-speaks-czechoslovakian": {
                "number":float(data[861]),
                "year": "2016",

            },

            "suburb-speaks-dan-(gio-dan)": {
                "number":float(data[862]),
                "year": "2016",

            },

            "suburb-speaks-danish": {
            ...
            "suburb-speaks-djambarrpuyngu": {
                "number":float(data[867]),
                "year": "2016",

            },

            "suburb-speaks-dravidian": {
            ...
            "suburb-speaks-eastern-european-languages": {
                "number":float(data[870]),
                "year": "2016",

            },

            "suburb-speaks-english": {
                "number":float(data[871]),
                "year": "2016",

            },

            "suburb-speaks-estonian": {
            ...
            "suburb-speaks-fijian": {
                "number":float(data[874]),
                "year": "2016",

            },

            "suburb-speaks-fijian-hindustani": {
                "number":float(data[875]),
                "year": "2016",

            },

            "suburb-speaks-filipino": {
                "number":float(data[876]),
                "year": "2016",

            },

            "suburb-speaks-finnish": {
                "number":float(data[877]),
                "year": "2016",

            },

            "suburb-speaks-french": {
                "number":float(data[878]),
                "year": "2016",

            },

            "suburb-speaks-french-creole": {
                "number":float(data[879]),
                "year": "2016",

            },

            "suburb-speaks-frisian": {
                "number":float(data[880]),
                "year": "2016",

            },

            "suburb-speaks-fulfulde": {
            ...
            "suburb-speaks-gaelic-(scotland)": {
                "number":float(data[883]),
                "year": "2016",

            },

            "suburb-speaks-georgian": {
                "number":float(data[884]),
                "year": "2016",

            },

            "suburb-speaks-german": {
                "number":float(data[885]),
                "year": "2016",

            },

            "suburb-speaks-gilbertese": {
            ...
            "suburb-speaks-gujarati": {
                "number":float(data[888]),
                "year": "2016",

            },

            "suburb-speaks-guugu-yimidhirr": {
            ...
            "suburb-speaks-hazaraghi": {
                "number":float(data[893]),
                "year": "2016",

            },

            "suburb-speaks-hebrew": {
            ...
            "suburb-speaks-iberian-romance": {
                "number":float(data[899]),
                "year": "2016",

            },

            "suburb-speaks-icelandic": {
            ...
            "suburb-speaks-iiokano": {
                "number":float(data[902]),
                "year": "2016",

            },

            "suburb-speaks-ilonggo-(hiligaynon)": {
                "number":float(data[903]),
                "year": "2016",

            },

            "suburb-speaks-inadequately-described": {
                "number":float(data[904]),
                "year": "2016",

            },

            "suburb-speaks-indo-aryan": {
                "number":float(data[905]),
                "year": "2016",

            },

            "suburb-speaks-indonesian": {
                "number":float(data[906]),
                "year": "2016",

            },

            "suburb-speaks-invented-languages": {
                "number":float(data[907]),
                "year": "2016",

            },

            "suburb-speaks-iranic": {
            ...
            "suburb-speaks-italian": {
                "number":float(data[910]),
                "year": "2016",

            },

            "suburb-speaks-japanese": {
                "number":float(data[911]),
                "year": "2016",

            },

            "suburb-speaks-javanese": {
            ...
            "suburb-speaks-kashmiri": {
                "number":float(data[916]),
                "year": "2016",

            },

            "suburb-speaks-key-word-sign-australia": {
            ...
            "suburb-speaks-kikuyu": {
                "number":float(data[919]),
                "year": "2016",

            },

            "suburb-speaks-kinyarwanda-(rwanda)": {
                "number":float(data[920]),
                "year": "2016",

            },

            "suburb-speaks-kirundi-(rundi)": {
                "number":float(data[921]),
                "year": "2016",

            },

            "suburb-speaks-konkani": {
                "number":float(data[922]),
                "year": "2016",

            },

            "suburb-speaks-korean": {
            ...
            "suburb-speaks-latvian": {
                "number":float(data[931]),
                "year": "2016",

            },

            "suburb-speaks-letzeburgish": {
                "number":float(data[932]),
                "year": "2016",

            },

            "suburb-speaks-liberian-(liberian-english)": {
                "number":float(data[933]),
                "year": "2016",

            },

            "suburb-speaks-lingala": {
                "number":float(data[934]),
                "year": "2016",

            },

            "suburb-speaks-lithuanian": {
                "number":float(data[935]),
                "year": "2016",

            },

            "suburb-speaks-loma-(lorma)": {
                "number":float(data[936]),
                "year": "2016",

            },

            "suburb-speaks-luganda": {
            ...
            "suburb-speaks-malayalam": {
                "number":float(data[942]),
                "year": "2016",

            },

            "suburb-speaks-maltese": {
                "number":float(data[943]),
                "year": "2016",

            },

            "suburb-speaks-mandaean-(mandaic)": {
                "number":float(data[944]),
                "year": "2016",

            },

            "suburb-speaks-mandarin": {
                "number":float(data[945]),
                "year": "2016",

            },

            "suburb-speaks-mandinka": {
            ...
            "suburb-speaks-manyjilyjarra": {
                "number":float(data[948]),
                "year": "2016",

            },

            "suburb-speaks-maori-(cook-island)": {
                "number":float(data[949]),
                "year": "2016",

            },

            "suburb-speaks-maori-(new-zealand)": {
                "number":float(data[950]),
                "year": "2016",

            },

            "suburb-speaks-marathi": {
                "number":float(data[951]),
                "year": "2016",

            },

            "suburb-speaks-mauritian-creole": {
                "number":float(data[952]),
                "year": "2016",

            },

            "suburb-speaks-middle-eastern-semitic-languages": {
                "number":float(data[953]),
                "year": "2016",

            },

            "suburb-speaks-min-nan": {
            ...
            "suburb-speaks-mon-khmer": {
                "number":float(data[956]),
                "year": "2016",

            },

            "suburb-speaks-mongolian": {
                "number":float(data[957]),
                "year": "2016",

            },

            "suburb-speaks-moro-(nuba-moro)": {
                "number":float(data[958]),
                "year": "2016",

            },

            "suburb-speaks-motu-(hirimotu)": {
                "number":float(data[959]),
                "year": "2016",

            },

            "suburb-speaks-murrinh-patha": {
                "number":float(data[960]),
                "year": "2016",

            },

            "suburb-speaks-nauruan": {
                "number":float(data[961]),
                "year": "2016",

            },

            "suburb-speaks-ndebele": {
                "number":float(data[962]),
                "year": "2016",

            },

            "suburb-speaks-nepali": {
                "number":float(data[963]),
                "year": "2016",

            },

            "suburb-speaks-ngarrindjeri": {
            ...
            "suburb-speaks-norf'k-pitcairn": {
                "number":float(data[966]),
                "year": "2016",

            },

            "suburb-speaks-norwegian": {
            ...
            "suburb-speaks-nyanja-(chichewa)": {
                "number":float(data[969]),
                "year": "2016",

            },

            "suburb-speaks-nyungar": {
                "number":float(data[970]),
                "year": "2016",

            },

            "suburb-speaks-oceanian-pidgins-and-creoles": {
            ...
            "suburb-speaks-other-eastern-asian-languages": {
                "number":float(data[974]),
                "year": "2016",

            },

            "suburb-speaks-other-southeast-asian-languages": {
                "number":float(data[975]),
                "year": "2016",

            },

            "suburb-speaks-other-southern-asian-languages": {
                "number":float(data[976]),
                "year": "2016",

            },

            "suburb-speaks-other-southern-european-languages": {
                "number":float(data[977]),
                "year": "2016",

            },

            "suburb-speaks-paakantyi": {
                "number":float(data[978]),
                "year": "2016",

            },

            "suburb-speaks-pacific-austronesian-languages": {
                "number":float(data[979]),
                "year": "2016",

            },

            "suburb-speaks-pampangan": {
                "number":float(data[980]),
                "year": "2016",

            },

            "suburb-speaks-papua-new-guinea-languages": {
                "number":float(data[981]),
                "year": "2016",

            },

            "suburb-speaks-pashto": {
                "number":float(data[982]),
                "year": "2016",

            },

            "suburb-speaks-persian-(excluding-dari)": {
                "number":float(data[983]),
                "year": "2016",

            },

            "suburb-speaks-pidgin": {
                "number":float(data[984]),
                "year": "2016",

            },

            "suburb-speaks-pitjantjatjara": {
                "number":float(data[985]),
                "year": "2016",

            },

            "suburb-speaks-polish": {
                "number":float(data[986]),
                "year": "2016",

            },

            "suburb-speaks-portuguese": {
                "number":float(data[987]),
                "year": "2016",

            },

            "suburb-speaks-portuguese-creole": {
                "number":float(data[988]),
                "year": "2016",

            },

            "suburb-speaks-punjabi": {
                "number":float(data[989]),
                "year": "2016",

            },

            "suburb-speaks-rohingya": {
                "number":float(data[990]),
                "year": "2016",

            },

            "suburb-speaks-romanian": {
                "number":float(data[991]),
                "year": "2016",

            },

            "suburb-speaks-romany": {
                "number":float(data[992]),
                "year": "2016",

            },

            "suburb-speaks-rotuman": {
                "number":float(data[993]),
                "year": "2016",

            },

            "suburb-speaks-russian": {
                "number":float(data[994]),
                "year": "2016",

            },

            "suburb-speaks-samoan": {
                "number":float(data[995]),
                "year": "2016",

            },

            "suburb-speaks-scandinavian": {
                "number":float(data[996]),
                "year": "2016",

            },

            "suburb-speaks-serbian": {
                "number":float(data[997]),
                "year": "2016",

            },

            "suburb-speaks-serbo-croatian/yugoslavian": {
                "number":float(data[998]),
                "year": "2016",

            },

            "suburb-speaks-seychelles-creole": {
                "number":float(data[999]),
                "year": "2016",

            },

            "suburb-speaks-shilluk": {
            ...
            "suburb-speaks-sign-languages": {
                "number":float(data[1002]),
                "year": "2016",

            },

            "suburb-speaks-sindhi": {
                "number":float(data[1003]),
                "year": "2016",

            },

            "suburb-speaks-sinhalese": {
                "number":float(data[1004]),
                "year": "2016",

            },

            "suburb-speaks-slovak": {
                "number":float(data[1005]),
                "year": "2016",

            },

            "suburb-speaks-slovene": {
                "number":float(data[1006]),
                "year": "2016",

            },

            "suburb-speaks-somali": {
                "number":float(data[1007]),
                "year": "2016",

            },

            "suburb-speaks-southeast-asian-austronesian-languages": {
                "number":float(data[1008]),
                "year": "2016",

            },

            "suburb-speaks-southern-asian-languages": {
                "number":float(data[1009]),
                "year": "2016",

            },

            "suburb-speaks-spanish": {
                "number":float(data[1010]),
                "year": "2016",

            },

            "suburb-speaks-spanish-creole": {
                "number":float(data[1011]),
                "year": "2016",

            },

            "suburb-speaks-swahili": {
                "number":float(data[1012]),
                "year": "2016",

            },

            "suburb-speaks-swedish": {
            ...
            "suburb-speaks-tigrinya": {
                "number":float(data[1024]),
                "year": "2016",

            },

            "suburb-speaks-timorese": {
                "number":float(data[1025]),
                "year": "2016",

            },

            "suburb-speaks-tok-pisin-(neomelanesian)": {
                "number":float(data[1026]),
                "year": "2016",

            },

            "suburb-speaks-tokelauan": {
                "number":float(data[1027]),
                "year": "2016",

            },

            "suburb-speaks-tongan": {
                "number":float(data[1028]),
                "year": "2016",

            },

            "suburb-speaks-tswana": {
            ...
            "suburb-speaks-turkic": {
                "number":float(data[1031]),
                "year": "2016",

            },

            "suburb-speaks-turkish": {
                "number":float(data[1032]),
                "year": "2016",

            },

            "suburb-speaks-turkmen": {
                "number":float(data[1033]),
                "year": "2016",

            },

            "suburb-speaks-tuvaluan": {
                "number":float(data[1034]),
                "year": "2016",

            },

            "suburb-speaks-ukrainian": {
            ...
            "suburb-speaks-vietnamese": {
                "number":float(data[1039]),
                "year": "2016",

            },

            "suburb-speaks-wajarri": {
                "number":float(data[1040]),
                "year": "2016",

            },

            "suburb-speaks-warlpiri": {
            ...
            "suburb-speaks-wergaia": {
                "number":float(data[1043]),
                "year": "2016",

            },

            "suburb-speaks-wiradjuri": {
            ...
            "suburb-speaks-yankunytjatjara": {
                "number":float(data[1047]),
                "year": "2016",

            },

            "suburb-speaks-yiddish": {
                "number":float(data[1048]),
                "year": "2016",

            },

            "suburb-speaks-yidiny": {
                "number":float(data[1049]),
                "year": "2016",

            },

            "suburb-speaks-yolngu-matha": {
                "number":float(data[1050]),
                "year": "2016",

            },

            "suburb-speaks-yorta-yorta": {
                "number":float(data[1051]),
                "year": "2016",

            },

            "suburb-speaks-yoruba": {
                "number":float(data[1052]),
                "year": "2016",

            },

            "suburb-speaks-yumplatok-(torres-strait-creole)": {
